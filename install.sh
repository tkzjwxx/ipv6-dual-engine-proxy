#!/bin/bash
# ====================================================================
# 极简双轨三体矩阵系统 V1.4.1 (中控 UI 进化版 | 内置直观向导)
...
# ====================================================================
# 6. 缔造大一统中控台：st (System Terminal) - 带 UI 直观部署向导
# ====================================================================
...
while true; do
    ...
    echo -e "  [\033[1;36m7\033[0m] ☁️ Argo Tunnel 自动化部署与映射向导"
    ...
    case $CMD in
        ...
        7)
            clear
            echo -e "\033[1;36m==================================================================\033[0m"
            echo -e "\033[1;32m               ☁️ Argo Tunnel 自动化部署与映射向导               \033[0m"
            echo -e "\033[1;36m==================================================================\033[0m"
            echo -e "\033[1;33m【第一步：获取核心 Token】\033[0m"
            echo -e " \033[1;37m1. 登录 Cloudflare Zero Trust 后台 -> Networks -> Tunnels\033[0m"
            echo -e " \033[1;37m2. 点击 Create a tunnel (选 Cloudflared) 并随意起名\033[0m"
            echo -e " \033[1;37m3. 复制网页给出的完整安装指令 (以 cloudflared service install 开头)\033[0m\n"
            echo -e "\033[1;33m【第二步：配置 Public Hostname 端口映射 (极其重要)】\033[0m"
            echo -e " \033[1;37m创建隧道后，请在 CF 网页端添加以下路由 (想用哪个通道就加哪个)：\033[0m"
            echo -e "  \033[1;35m[A轨原生]\033[0m 域名: v1.你的域名.com -> Service: \033[1;32mHTTP\033[0m -> URL: \033[1;32mlocalhost:10001\033[0m (VLESS)"
            echo -e "  \033[1;35m[A轨原生]\033[0m 域名: m1.你的域名.com -> Service: \033[1;32mHTTP\033[0m -> URL: \033[1;32mlocalhost:10002\033[0m (VMess)"
            echo -e "  \033[1;34m[B轨WARP]\033[0m 域名: v2.你的域名.com -> Service: \033[1;32mHTTP\033[0m -> URL: \033[1;32mlocalhost:10003\033[0m (VLESS)"
            echo -e "  \033[1;34m[B轨WARP]\033[0m 域名: m2.你的域名.com -> Service: \033[1;32mHTTP\033[0m -> URL: \033[1;32mlocalhost:10004\033[0m (VMess)"
            echo -e "\033[1;36m------------------------------------------------------------------\033[0m"
            read -p "🔑 请在此粘贴【第一步】获取的完整指令或 Token 并回车: " RAW_INPUT
            ...
            if [ -n "$ARGO_TOKEN" ]; then
                ...
                echo -e "\033[1;90m* 提示：请确保你已经完成了上方【第二步】的域名映射配置，然后按 8 提取节点！\033[0m"
            else
